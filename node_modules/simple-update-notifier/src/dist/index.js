...
var isNpmOrYarn_1 = require("./isNpmOrYarn");
var hasNewVersion_1 = require("./hasNewVersion");
var borderedText_1 = require("./borderedText");
var simpleUpdateNotifier = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, hasNewVersion_1["default"](args)];
            case 2:
                latestVersion = _a.sent();
                if (latestVersion) {
                    console.error(borderedText_1["default"]("New version of " + args.pkg.name + " available!\nCurrent Version: " + args.pkg.version + "\nLatest Version: " + latestVersion));
                }
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
