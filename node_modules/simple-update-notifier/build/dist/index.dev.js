...
var configDir = process.env.XDG_CONFIG_HOME || path.join(homeDirectory, '.config', 'simple-update-notifier');

var getConfigFile = function getConfigFile(packageName) {
  return path.join(configDir, "".concat(packageName.replace('@', '').replace('/', '__'), ".json"));
};

var createConfigDir = function createConfigDir() {
...
var getLastUpdate = function getLastUpdate(packageName) {
...
var saveLastUpdate = function saveLastUpdate(packageName) {
  var configFile = getConfigFile(packageName);
...
var getDistVersion = function getDistVersion(packageName, distTag) {
...
var hasNewVersion = function hasNewVersion(_a) {
  var pkg = _a.pkg,
      _b = _a.updateCheckInterval,
      updateCheckInterval = _b === void 0 ? 1000 * 60 * 60 * 24 : _b,
      _c = _a.distTag,
      distTag = _c === void 0 ? 'latest' : _c,
      alwaysRun = _a.alwaysRun,
      debug = _a.debug;
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        case 0:
          ...
          if (!(alwaysRun || !lastUpdateCheck || lastUpdateCheck < new Date().getTime() - updateCheckInterval)) return [3
          /*break*/
          , 2];
          return [4
          /*yield*/
          , getDistVersion(pkg.name, distTag)];
...
var borderedText = function borderedText(text) {
  var lines = text.split('\n');
  var width = Math.max.apply(Math, lines.map(function (l) {
    return l.length;
  }));
...
var simpleUpdateNotifier = function simpleUpdateNotifier(args) {
  return __awaiter(void 0, void 0, void 0, function () {
    var latestVersion, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!args.alwaysRun && (!process.stdout.isTTY || isNpmOrYarn && !args.shouldNotifyInNpmScript)) {
            if (args.debug) {
        ...
        case 3:
          err_1 = _a.sent(); // Catch any network errors or cache writing errors so module doesn't cause a crash
