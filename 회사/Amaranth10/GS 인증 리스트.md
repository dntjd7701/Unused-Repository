...
const { gridMst } = this.state

const parameters = (() => {

return {

moduleCd: this.props.menuItem.moduleCode,

trCd: () => gridMst?.getSelectedRow()?.trCd || '',

attrNm: () => gridMst?.getSelectedRow()?.attrNm || '',

shipCd: () => gridMst?.getSelectedRow()?.shipCd || '',

divCd: () => gridMst?.getSelectedRow()?.divCd || '',

baseDt: () => gridMst?.getSelectedRow()?.baseDt || '',

exchCd: () => gridMst?.getSelectedRow()?.exchCd || '',

itemCd: () => gridMst?.getSelectedRow()?.itemCd || '',

itemNm: () => gridMst?.getSelectedRow()?.itemNm || '',

bomitemCd: () => gridMst?.getSelectedRow()?.bomitemCd || '',

setItemCd: () => gridMst?.getSelectedRow()?.setItemCd || '',

table: '',

key1: () => gridMst?.getSelectedRow()?.key1 || '',

key2: () => gridMst?.getSelectedRow()?.key2 || '',

}

})();

this.logisUtil.setInfomationBar(this, target, parameters);

} catch (error) {

LogisMessage.showErrorMessage(this.pageContainer, error);
